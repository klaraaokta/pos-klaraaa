@push('styles')
    <style>
        ...
        .pos-navbar .btn-danger:hover {
            background-color: var(--pos-danger-hover);
            border-color: var(--pos-danger-hover);
        }
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="posNavbarContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('dashboard') ? 'active link-dark fw-bold' : '' }}"
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('produk') ? 'active link-dark fw-bold' : '' }}"
                        aria-current="page" href="{{ route('produk.index') }}">Produk</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('penjualan') ? 'active link-dark fw-bold' : '' }}"
                        aria-current="page" href="{{ route('penjualan.index') }}">Penjualan</a>
                </li>
            </ul>
